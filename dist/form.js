...
},{"event-manager":17}],17:[function(require,module,exports){
...
var EventManager = {
    ...
    _addEvent: function (target, eventName, listener, useCapture, context) {
        ...
        var existingListeners = utils.getNested(this._getTargetMap(target), eventName);
        if (!existingListeners) {
            existingListeners = utils.setNested(this._getTargetMap(target), eventName, []);
        }
...
},{"request":18,"underscore":20,"utils":19}],18:[function(require,module,exports){
'use strict';
...
},{"promise":10}],19:[function(require,module,exports){
'use strict';
...
},{"element-kit":6}],20:[function(require,module,exports){
//     Underscore.js 1.8.2
