...
module.exports = (function (){
    ...
    let deviceManagerIsMobileStub, redrawOptionsContainerStub;
    ...
    QUnit.test('initialize, setup, and destruction', function() {
        ...
        let uiSelectedValueContainer = uiEl.getElementsByClassName(uiSelectedValueContainerClass)[0];
    ...
    QUnit.test('initializing when a dropdown item is pre-selected', function() {
        ...
        let uiOptionsClass = 'my-option';
        let uiSelectedValueContainerClass = 'my-selected-val-container';
        let uiOptionsSelectedClass = 'my-option-selected';
    ...
    QUnit.test('clicking through ui dropdown selections', function() {
        ...
        let uiOptionEls = uiOptionsContainerEl.getElementsByClassName(uiOptionsClass);
        let uiSelectedValueContainerEl = uiEl.getElementsByClassName(uiSelectedValueContainerClass)[0];
    ...
    QUnit.test('get ui option element by its data', function() {
        ...
        let dropdown = new Dropdown({el: selectEl, optionsClass: optionsClass});
        let uiOptions = dropdown.getUIElement().getElementsByClassName(optionsClass);
    ...
    QUnit.test('new value changed on select dropdown updates its ui counterpart', function() {
        ...
        let valueContainer = fixture.getElementsByClassName('dropdown-value-container')[0];
    ...
    QUnit.test('ui selected display value is set to selected option\'s display value when initializing with the disabled select option with a selected option', function() {
        QUnit.expect(1);
        let fixture = document.getElementById('qunit-fixture');
        let testDisplayValue = 'My Placeholder';
        let html =
            '<select disabled>' +
        ...
        let uiSelectedValueContainerClass = 'my-selected-val-container';
        let dropdown = new Dropdown({el: selectEl, selectedValueContainerClass: uiSelectedValueContainerClass});
        let uiSelectedValueContainerEl = fixture.getElementsByClassName(uiSelectedValueContainerClass)[0];
    ...
    QUnit.test('clicking on another ui dropdown element inside of the same form should hide the ui options container element', function() {
        ...
        let uiOptionsContainerActiveClass = 'active-options-container';
        let uiSelectedValueContainerClass = 'my-selected-val-container';
        let selectEls = formEl.getElementsByTagName('select');
        let firstDropdown = new Dropdown({
            el: selectEls[0],
            containerClass: uiContainerClass,
            optionsContainerActiveClass: uiOptionsContainerActiveClass,
            selectedValueContainerClass: uiSelectedValueContainerClass
        });
        let secondDropdown = new Dropdown({
            el: selectEls[1],
            containerClass: uiContainerClass,
            optionsContainerActiveClass: uiOptionsContainerActiveClass,
            selectedValueContainerClass: uiSelectedValueContainerClass
    ...
    QUnit.test('updateOptions() should create new form and UI elements from objects in the array that it is passed', function() {
        ...
        let newOptions = [{dataValue: 'TW', displayValue: 'Twitter'}];
        dropdown.updateOptions(newOptions);
        let formOptionElements = fixture.getElementsByTagName('option');
        let uiOptionElements = fixture.getElementsByClassName(uiOptionsClass);
    ...
    QUnit.test('calling showOptionsContainer() the first time should set first option as selected if there is not a pre-selected option', function() {
        ...
        let uiOptionEls = dropdown.getUIElement().getElementsByClassName(uiOptionsClass);
