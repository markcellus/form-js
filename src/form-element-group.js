 ...
 * @callback FormElements~onChange
...
/**
 * A callback function that fires when one of the button toggle elements are selected
 * @callback FormElements~onSelect
 ...
 * @callback FormElements~onDeselect
 ...
 * @extends FormElement
 */
var FormElements = FormElement.extend({

    /**
     * Initialization.
     * @param {object} options - Options passed into instance
     * @param {Array|HTMLInputElement} options.inputs - The collection of input elements to be made into toggle items
     * @param {FormElements~onChange} [options.onChange] - A callback function that fires when one of the toggle elements are selected
     ...
     * @param {FormElements~onSelect} [options.onSelect] - A callback function that fires when the button toggle element is selected
     * @param {FormElements~onDeselect} [options.onDeselect] - A callback function that fires when the button toggle element is deselected
    ...
    getElementKey: function () {
        if (this.isRadio()) {
            return 'FormElementsRadio';
        } else {
            return 'FormElementsCheckbox';
        }
    },
